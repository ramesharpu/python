...
documentation topic, and a help page is printed on the console. If the argument is any other kind of object,
a help page on the object is generated.
"""

# open python in terminal
# type help
# then type the required word, say "string" it will display the details